...
namespace ProgressCapture.Web.Migrations
{
    ...
    [Migration("20260219033425_RowLevelAuth")]
    partial class RowLevelAuth
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProgressCapture.Web.Models.Goal", b =>
                {
                    ...
                    b.HasIndex("AppUserId")
                        .HasDatabaseName("ix_goal_app_user_id");
            ...
            modelBuilder.Entity("ProgressCapture.Web.Models.Goal", b =>
                {
                    b.HasOne("ProgressCapture.Web.Models.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_goal_asp_net_users_app_user_id");
